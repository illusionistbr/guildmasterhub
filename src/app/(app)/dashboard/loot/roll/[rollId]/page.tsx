...
import type { Guild, LootRoll, LootRollEntry, GuildMemberRoleInfo } from '@/types/guildmaster';
        ...
        {roll.status === 'ended' && !roll.isDistributed && canEditRoll && (
            <Card className="static-card-container border-amber-500/50">
                <CardHeader>
                    ...
                    <CardDescription>
                        Após entregar o item fisicamente ao vencedor da rolagem, marque-o como distribuído para finalizar o processo e atualizar o status no banco da guilda.
                    </CardDescription>
                </CardHeader>
